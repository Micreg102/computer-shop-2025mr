...
export default function AddToCartButton({ productId, disabled }: { productId: number, disabled?: boolean }) {
    ...
    return (
        <button
            ...
            className="w-full lg:w-auto bg-red-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
